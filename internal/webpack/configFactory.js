  ...
  let webpackConfig = {
    ...
    resolve: {
      ...
      alias: {
        ...
        api: path.resolve(appRootDir.get(), './api'),
        config: path.resolve(appRootDir.get(), './config'),
        shared: path.resolve(appRootDir.get(), './shared'),
        client: path.resolve(appRootDir.get(), './client'),
        server: path.resolve(appRootDir.get(), './server'),
        data: path.resolve(appRootDir.get(), './data'),
        utils: path.resolve(appRootDir.get(), './shared/utils'),
        store: path.resolve(appRootDir.get(), './shared/store'),
        routes: path.resolve(appRootDir.get(), './shared/routes'),
        ...
        layouts: path.resolve(appRootDir.get(), './shared/layouts'),
        addons: path.resolve(appRootDir.get(), './shared/addons'),
        const: path.resolve(appRootDir.get(), './const'),
      },
    },
    ...
    plugins: removeNil([
      ...
      // ifDevClient(() => new BundleAnalyzerPlugin()),
